...
export function ProgressBar({ position, duration, onSeek }: ProgressBarProps) {
  ...
  const screenTheme = buildScreenTheme(getThemePalette(getResolvedTheme(themeMode, systemTheme), accentColor));
  ...
  return (
    ...
    >
      <View style={[styles.track, { backgroundColor: screenTheme.progressTrackBackground }]}>
        <View
          style={[
            styles.fill,
            {
              width: `${progress * 100}%`,
              backgroundColor: screenTheme.progressFillBackground,
            },
          ]}
        />
        <View
          style={[
            ...
            {
              left: `${progress * 100}%`,
              backgroundColor: screenTheme.progressThumbBackground,
            },
          ]}
        />
      </View>
